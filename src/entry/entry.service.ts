...
export class EntryService {
    constructor(private readonly entryRepository: EntryRepository, private readonly userAppService: UserAppService) { }

    async createEntry(dto: CreateEntryDto, userId: string): Promise<EntryResponseDto> {
