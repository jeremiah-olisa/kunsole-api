...
import { EntryResponseDto, PaginatedResultEntryResponseDto } from './dtos/entry-response.dto';
...
export class EntryController {
    ...
    async findAll(
        ...
        const user = new UserEntity(req.user);
        return this.entryService.listEntries({ ...query.getFilters(), userId: user.getUserId() }, query.getPagination());
    }
