...
export class PlanResponseDto {
    ...
    @ApiProperty({
        description: 'Detailed description of the plan, explaining its features and benefits.',
        example: 'This plan provides advanced features for growing businesses, including priority support.',
    })
    description: string;
    ...
    @ApiProperty({
        description: 'A collection of features included in this plan, with each feature being either enabled or disabled.',
        example: {
