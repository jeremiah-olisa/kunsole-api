...
import { PaginatedResultPlanResponseDto, PlanResponseDto } from './dtos/plan-response.dto';
...
export class PlanController {
    ...
    async findAll(@Query() pagination: any): Promise<PaginatedResult<PlanResponseDto>> {
